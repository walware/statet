	...
	protected AbstractSyntaxColoringBlock createConfigurationBlock() {
		...
		AbstractSyntaxColoringBlock syntaxBlock = new AbstractSyntaxColoringBlock() {
			...
			protected SyntaxNode[] createItems() {
				...
				identifierChilds.add(
						new StyleNode(Messages.RSyntaxColoring_Identifier_Flowcontrol_label, getIdentifierItemsDescription(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_FLOWCONTROL_ITEMS), 
								...
								SyntaxNode.createUseCustomStyle() }, null));
				if (getPreferenceStore().getString(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM1_ITEMS).length() > 0 && "".equals(getPreferenceStore().getString(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM1_USE))) { //$NON-NLS-1$
					identifierChilds.add(
							new StyleNode("Custom1", getIdentifierItemsDescription(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM1_ITEMS),  //$NON-NLS-1$
									RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM1_ROOT, new SyntaxNode.UseStyle[] { SyntaxNode.createUseCustomStyle() }, null));
				}
				if (getPreferenceStore().getString(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM2_ITEMS).length() > 0 && "".equals(getPreferenceStore().getString(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM2_USE))) { //$NON-NLS-1$
					identifierChilds.add(
							new StyleNode("Custom2", getIdentifierItemsDescription(RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM2_ITEMS),  //$NON-NLS-1$
									RUIPreferenceConstants.R.TS_IDENTIFIER_SUB_CUSTOM2_ROOT, new SyntaxNode.UseStyle[] { SyntaxNode.createUseCustomStyle() }, null));
				}
			...
			protected String[] getSettingsContexts() {
				return new String[] { RUIPreferenceConstants.R.CONTEXT_ID };
			}
