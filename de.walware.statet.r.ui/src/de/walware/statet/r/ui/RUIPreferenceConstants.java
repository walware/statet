...
public class RUIPreferenceConstants {
	...
	public interface R {
		...
		public final static String TS_NUMBERS_SUB_INT_USE = TS_NUMBERS_SUB_INT_ROOT + TS_USE_SUFFIX;
		public final static String TS_NUMBERS_SUB_INT_COLOR = TS_NUMBERS_SUB_INT_ROOT + TS_COLOR_SUFFIX;
		public final static String TS_NUMBERS_SUB_INT_BOLD = TS_NUMBERS_SUB_INT_ROOT + TS_BOLD_SUFFIX;
		public final static String TS_NUMBERS_SUB_INT_ITALIC = TS_NUMBERS_SUB_INT_ROOT + TS_ITALIC_SUFFIX;
		public final static String TS_NUMBERS_SUB_INT_UNDERLINE = TS_NUMBERS_SUB_INT_ROOT + TS_UNDERLINE_SUFFIX;
		public final static String TS_NUMBERS_SUB_INT_STRIKETHROUGH = TS_NUMBERS_SUB_INT_ROOT + TS_STRIKETHROUGH_SUFFIX;
		
		public final static String TS_NUMBERS_SUB_CPLX_ROOT = IRTextTokens.NUM_SUB_CPLX_KEY;
		public final static String TS_NUMBERS_SUB_CPLX_USE = TS_NUMBERS_SUB_CPLX_ROOT + TS_USE_SUFFIX;
		public final static String TS_NUMBERS_SUB_CPLX_COLOR = TS_NUMBERS_SUB_CPLX_ROOT + TS_COLOR_SUFFIX;
		public final static String TS_NUMBERS_SUB_CPLX_BOLD = TS_NUMBERS_SUB_CPLX_ROOT + TS_BOLD_SUFFIX;
		public final static String TS_NUMBERS_SUB_CPLX_ITALIC = TS_NUMBERS_SUB_CPLX_ROOT + TS_ITALIC_SUFFIX;
		public final static String TS_NUMBERS_SUB_CPLX_UNDERLINE = TS_NUMBERS_SUB_CPLX_ROOT + TS_UNDERLINE_SUFFIX;
		public final static String TS_NUMBERS_SUB_CPLX_STRIKETHROUGH = TS_NUMBERS_SUB_CPLX_ROOT + TS_STRIKETHROUGH_SUFFIX;
	...
	public static void initializeDefaultValues(final IPreferenceStore store) {
		...
		for (final String root : numberSubs) {
			store.setDefault(root + TS_USE_SUFFIX, R.TS_NUMBERS_ROOT);
			PreferenceConverter.setDefault(store, root + TS_COLOR_SUFFIX, new RGB(0, 0, 127));
			store.setDefault(root + TS_BOLD_SUFFIX, false);
			store.setDefault(root + TS_ITALIC_SUFFIX, false);
			store.setDefault(root + TS_UNDERLINE_SUFFIX, false);
			store.setDefault(root + TS_STRIKETHROUGH_SUFFIX, false);
