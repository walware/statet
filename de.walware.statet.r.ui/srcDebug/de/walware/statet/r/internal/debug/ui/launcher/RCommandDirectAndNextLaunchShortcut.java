 ...
 */
public class RCommandDirectAndNextLaunchShortcut extends RCommandDirectLaunchShortcut {
	
	
	public RCommandDirectAndNextLaunchShortcut() {
	}
	...
	protected void postLaunch(final ITextEditor textEditor, final IDocument doc, final RAstNode[] nodes) {
		try {
			final int offset = getNextOffset(nodes[nodes.length-1], doc);
