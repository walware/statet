...
import de.walware.statet.r.internal.sweave.RweaveTexTemplatesContextType;
...
public class RChunkTemplatesCompletionProcessor extends TemplateCompletionProcessor {
	...
	public RChunkTemplatesCompletionProcessor(final ISourceEditor editor) {
...
//					&& template.getPattern().startsWith(prefix)
	...
	protected Image getImage(final Template template) {
		return LTKUI.getImages().get(LTKUI.OBJ_TEXT_TEMPLATE);
	}
