...
import de.walware.statet.base.ui.sourceeditors.ITextEditorEffectSynchronizer;
import de.walware.statet.base.ui.sourceeditors.StatextEditor1;


/**
 * Like default {@link TemplateProposal}, but 
 *   <li>supports {@link ITextEditorEffectSynchronizer}</li>
 */
public class StatextTemplateProposal implements ICompletionProposal, ICompletionProposalExtension, ICompletionProposalExtension2, ICompletionProposalExtension3, ICompletionProposalExtension5 {
...
//	
	...
	public String getDisplayString() {
		if (fDisplayString == null) {
			...
			fDisplayString = NLS.bind("{0} - {1}", arguments);
		}
		...
		try {
			...
			if (hasPositions) {
				...
				if (fContext instanceof IExtTemplateContext) {
					final StatextEditor1 editor = ((IExtTemplateContext) fContext).getEditor();
					if (editor != null) {
