...
/* Set of Image Keys **********************************************************/
	public static final String IMG_CONTENTASSIST_TEMPLATE = StatetPlugin.PLUGIN_ID + ".image.contentassist.template";  //$NON-NLS-1$
	
	public static final String IMG_LAUNCHCONFIG_MAIN = StatetPlugin.PLUGIN_ID + ".image.launchconfig.main";  //$NON-NLS-1$
	
	public static final String IMG_OBJ_COMMAND = StatetPlugin.PLUGIN_ID + ".image.obj.command";  //$NON-NLS-1$
	public static final String IMG_OBJ_COMMAND_DUMMY = StatetPlugin.PLUGIN_ID + ".image.obj.commanddummy";  //$NON-NLS-1$
	
	public static final String IMG_LOCTOOL_SORT_ALPHA = StatetPlugin.PLUGIN_ID + ".tool.sort.alpha";  //$NON-NLS-1$
